...
```
Based on SHAP value, the most influential factors are whether individuals smoke, their age, bmi, and children. Their sex and region appear to be lowly influential to the models predictability relative to the previous features mentioned.
...
joblib.dump(model_artifact, "model_artifact.pkl")
```