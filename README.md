...
![Python](https://img.shields.io/badge/python-3.10+-blue.svg) ![License](https://img.shields.io/badge/license-DbCL--1.0-blue)
...
The analysis is structured in **four phases** across 3 documents: Render PDF and HTML of both markdowns can be found in `docs` folder. - dataExploration.qmd - dataModeling.qmd - app.py
...
**Numerical Features** - Distribution shape (histograms, KDEs)\
...
**Categorical vs Target** - Sex vs charges\
- Smoker status vs charges\
- Region vs charges\
- Family size vs charges

**Numerical vs Target** - Age vs charges\
- BMI vs charges\
...
![App Screenshot](img/modeling_screenshot.png)
